function converter_volume(numero, unidade_origem, unidade_destino)
    ...
    volume_em_unidade_origem = 
        ...
        elseif unidade_origem == "Milha cúbica"
            numero * (1609.34^3)
        elseif unidade_origem == "Quilolitro"
            numero
        ...
        elseif unidade_origem == "minim"
            ...
            return "Unidade de volume de origem não suportada"
        end
    ...
    resultado = 
        ...
        elseif unidade_destino == "Quilolitro"
            volume_em_unidade_origem
        ...
        elseif unidade_destino == "minim"
            ...
            return "Unidade de volume de destino não suportada"
        end
